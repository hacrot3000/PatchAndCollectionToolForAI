...
v6.10.1 retains the dedicated collector process group and
...
v6.10.1 retains canonical successful completion output. A collector that reports the
...
## v6.10.1 post-exit drain repair
...
## v6.10.1 drain-window signal repair
...
## v6.10.1 narrow-terminal completion banner
