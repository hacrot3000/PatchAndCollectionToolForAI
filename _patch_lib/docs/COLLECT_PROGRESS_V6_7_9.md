...
v6.7.9 additionally places the collector in a dedicated process group and
forwards SIGINT/SIGTERM from the supervisor. If an IDE/task runner terminates
...
v6.7.9 canonicalizes successful completion output. A collector that reports the
