...
v6.9.4 retains the dedicated collector process group and
...
v6.9.4 retains canonical successful completion output. A collector that reports the
...
## v6.9.4 drain-window signal repair
