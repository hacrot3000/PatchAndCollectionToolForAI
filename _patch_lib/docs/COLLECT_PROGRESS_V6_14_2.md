# COLLECT progress / self-contained collector v6.17.1
...
v6.17.1 keeps one-line TTY progress, terminal-width safety, bounded FAIL output, signal forwarding, post-exit drain cleanup, verified result-ZIP validation and one highlighted `[PRIMARY - UPLOAD THIS FILE]` path.
