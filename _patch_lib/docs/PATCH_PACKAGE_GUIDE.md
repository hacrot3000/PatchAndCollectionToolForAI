# PATCH PACKAGE GUIDE — v6.15.1 authoritative AI/tool contract
...
{
  "compatibility": {
    "min_tool_version": "6.15.1",
    "max_tool_version": "7.0.0",
    "max_tested_version": "6.15.1"
  }
}
```
