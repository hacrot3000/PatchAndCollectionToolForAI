...
v6.9.6 retains the dedicated collector process group and
...
v6.9.6 retains canonical successful completion output. A collector that reports the
...
## v6.9.6 drain-window signal repair
...
## v6.9.6 narrow-terminal completion banner
