...
with tempfile.TemporaryDirectory(prefix='ptv613_recovery_') as td:
    ...
    # v6.19.5 executes the unrelated later PATCH, but the failed preflight row
...
print('PASS: v6.19.5 diagnosis, FAIL_HANDOFF, source-drift recollection, LAST_RUN/resume/history')
