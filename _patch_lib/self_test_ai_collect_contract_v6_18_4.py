...
expected={'pack','zip','overview','ls','tree','find','search','search_files','content','research','file','range','head','tail','symbol','references','callgraph','dependencies','directory','symbol_graph','decompile','ida','ghidra','git'}
...
print('PASS: v6.18.4 exact self-contained AI COLLECT/PATCH documentation contract')
