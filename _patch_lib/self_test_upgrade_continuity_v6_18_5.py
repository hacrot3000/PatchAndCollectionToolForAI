...
assert (HERE/'self_test_collect_historical_actions_v6_18_5.py').is_file()
...
print('PASS: v6.18.5 upgrade continuity guard preserves current capabilities and requires historical behavioral/ledger gates')
