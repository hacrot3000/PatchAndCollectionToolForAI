...
assert c.VERSION==q.VERSION=='6.19.5'
...
with tempfile.TemporaryDirectory(prefix='ptv_cleartext_history_') as td:
    ...
    manifest={'format':'python-patch-tool-code-collection','format_version':3,'tool_version':'6.19.5','collection_status':'PASS','files':[],'reports':[]}
...
print('PASS: v6.19.5 ZIP clear-text companions for COLLECT and FAIL_HANDOFF')
