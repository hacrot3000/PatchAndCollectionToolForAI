...
assert (HERE/'VERSION').read_text(encoding='utf-8').strip() == '6.17.12'
...
print('PASS: v6.17.12 item-local batch preflight failures continue independent PATCHes and block only related successors')
