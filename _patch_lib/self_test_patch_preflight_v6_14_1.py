...
validate_manifest(representative); assert check_compatibility(representative,'6.14.1')==[]
print('PASS: v6.14.1 exact PATCH schema, preflight, compatibility and partial-modification detection')
