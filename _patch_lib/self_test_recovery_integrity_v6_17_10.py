...
assert q.VERSION == '6.17.10'
assert r.VERSION == '6.17.10'
...
print('PASS: v6.17.10 recovery identity, rollback replay dedupe exception, unbounded ignored-file fail-safe and clean artifact safety error')
