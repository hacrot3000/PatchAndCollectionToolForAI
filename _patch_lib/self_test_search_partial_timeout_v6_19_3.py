...
print('PASS: v6.19.3 regex large-tree optimization, partial-timeout checkpoint and INCOMPLETE preservation contract')
...
print('PASS: v6.19.3 discovery/output quota partial-preservation contract')
...
print('PASS: v6.19.3 exact pack quota remains fail-closed')
