...
# even though v6.17.10 defaults to continue_independent.
mixed={
...
# Renderer supports the v6.17.10 continue_independent default: multiple FAIL rows
...
print('PASS: v6.17.10 persistent batch summary, aggregate/detail logs, continuation/safety-stop status model and report browser')
