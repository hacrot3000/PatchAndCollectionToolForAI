...
with tempfile.TemporaryDirectory(prefix='ptv-failed-group-') as td:
    ...
    assert 'New patch/collect:' in rendered and 'Last failed patch/collect:' in rendered,rendered
...
print('PASS: v6.19.4 previous failed PATCH/COLLECT are a normal second queue group; Smart Resume is explicit-only')
