...
# v6.18.4: even an internal/tool failure may continue independent work only when
...
print('PASS: v6.18.4 audit regressions cover rollback completeness, contained-failure continuation, COLLECT self-output, mutation integrity, idempotency, Git, archives and limits')
