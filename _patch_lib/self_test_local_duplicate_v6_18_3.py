...
with tempfile.TemporaryDirectory(prefix='ptv680dup_split_') as td:
    ...
    # v6.18.3 retires confirmed local duplicates into patchs/ignore immediately.
...
# v6.18.3 hardens the whole queue boundary: patchs/ itself must never be a
...
# v6.18.3 deliberately has no project/process queue lock. Independent terminal
...
print('PASS: v6.18.3 current-session duplicate collapse plus local-history duplicate contract')
