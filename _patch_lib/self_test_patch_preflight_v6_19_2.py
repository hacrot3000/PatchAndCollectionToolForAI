...
validate_manifest(representative); assert check_compatibility(representative,'6.19.2')==[]
print('PASS: v6.19.2 exact PATCH schema, preflight, compatibility and partial-modification detection')
