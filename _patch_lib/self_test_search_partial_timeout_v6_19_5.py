...
print('PASS: v6.19.5 regex large-tree optimization, partial-timeout checkpoint and INCOMPLETE preservation contract')
...
print('PASS: v6.19.5 discovery/output quota partial-preservation contract')
...
print('PASS: v6.19.5 exact pack quota remains fail-closed')
