...
validate_manifest(representative); assert check_compatibility(representative,'6.18.5')==[]
print('PASS: v6.18.5 exact PATCH schema, preflight, compatibility and partial-modification detection')
