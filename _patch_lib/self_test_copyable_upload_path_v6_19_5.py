...
assert a.VERSION==q.VERSION=='6.19.5'
...
print('PASS: v6.19.5 copy-friendly short hard-link upload aliases keep ACTION REQUIRED paths on dedicated rows with safe fallback')
