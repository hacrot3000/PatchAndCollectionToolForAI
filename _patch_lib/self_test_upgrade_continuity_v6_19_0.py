...
assert (HERE/'self_test_collect_historical_actions_v6_19_0.py').is_file()
...
print('PASS: v6.19.0 upgrade continuity guard preserves current capabilities and requires historical behavioral/ledger gates')
