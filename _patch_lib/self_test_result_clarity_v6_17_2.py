...
with tempfile.TemporaryDirectory(prefix='ptv6151_result_fail_') as td:
    ...
    assert 'SUMMARY: FAIL | failed=1 | policy=fail_fast | last=patch_visual_fail.zip rc=7' in text,text
...
print('PASS: v6.17.2 final result clarity, patch highlighting and red/yellow FAIL banner contract')
