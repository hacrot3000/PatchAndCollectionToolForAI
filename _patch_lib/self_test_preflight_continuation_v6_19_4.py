...
assert (HERE/'VERSION').read_text(encoding='utf-8').strip() == '6.19.4'
...
print('PASS: v6.19.4 item-local batch preflight failures continue independent PATCHes and block only related successors')
