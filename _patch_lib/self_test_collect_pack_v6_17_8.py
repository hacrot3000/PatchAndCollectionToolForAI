...
with tempfile.TemporaryDirectory(prefix='ptv612_pack_') as td:
    ...
    with zipfile.ZipFile(results[0]) as z:
        ...
        assert manifest['tool_version']=='6.17.8' and manifest['file_count']==2
...
print('PASS: v6.17.8 self-contained COLLECT actions pack/overview/find/search/git and exact schema')
