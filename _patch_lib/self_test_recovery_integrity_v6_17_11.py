...
assert q.VERSION == '6.17.11'
assert r.VERSION == '6.17.11'
...
print('PASS: v6.17.11 recovery identity, rollback replay dedupe exception, unbounded ignored-file fail-safe and clean artifact safety error')
