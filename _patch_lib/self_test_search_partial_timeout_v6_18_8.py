...
print('PASS: v6.18.8 regex large-tree optimization, partial-timeout checkpoint and INCOMPLETE preservation contract')
...
print('PASS: v6.18.8 discovery/output quota partial-preservation contract')
...
print('PASS: v6.18.8 exact pack quota remains fail-closed')
