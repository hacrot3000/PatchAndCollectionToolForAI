...
print('PASS: v6.19.2 regex large-tree optimization, partial-timeout checkpoint and INCOMPLETE preservation contract')
...
print('PASS: v6.19.2 discovery/output quota partial-preservation contract')
...
print('PASS: v6.19.2 exact pack quota remains fail-closed')
