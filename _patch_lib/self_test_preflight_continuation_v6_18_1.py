...
assert (HERE/'VERSION').read_text(encoding='utf-8').strip() == '6.18.1'
...
print('PASS: v6.18.1 item-local batch preflight failures continue independent PATCHes and block only related successors')
