...
assert q.VERSION == '6.17.7'
assert r.VERSION == '6.17.7'
...
print('PASS: v6.17.7 recovery identity, rollback replay dedupe exception, unbounded ignored-file fail-safe and clean artifact safety error')
