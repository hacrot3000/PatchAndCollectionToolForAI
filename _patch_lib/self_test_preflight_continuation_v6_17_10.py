...
assert (HERE/'VERSION').read_text(encoding='utf-8').strip() == '6.17.10'
...
print('PASS: v6.17.10 item-local batch preflight failures continue independent PATCHes and block only related successors')
