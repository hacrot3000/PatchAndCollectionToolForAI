...
assert (HERE/'self_test_collect_historical_actions_v6_19_4.py').is_file()
...
print('PASS: v6.19.4 upgrade continuity guard preserves current capabilities and requires historical behavioral/ledger gates')

# v6.19.4 UX continuity: normal startup must group previous failures rather than auto-open Smart Resume.
...
assert (HERE/'self_test_failed_queue_grouping_v6_19_4.py').is_file()
