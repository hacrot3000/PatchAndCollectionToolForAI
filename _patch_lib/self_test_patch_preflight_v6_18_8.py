...
validate_manifest(representative); assert check_compatibility(representative,'6.18.8')==[]
print('PASS: v6.18.8 exact PATCH schema, preflight, compatibility and partial-modification detection')
