...
assert q.VERSION == '6.17.8'
assert r.VERSION == '6.17.8'
...
print('PASS: v6.17.8 recovery identity, rollback replay dedupe exception, unbounded ignored-file fail-safe and clean artifact safety error')
