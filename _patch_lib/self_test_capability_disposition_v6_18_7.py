...
assert current['current_version']=='6.18.7'
...
surface_only={'self_test_upgrade_continuity_v6_18_7.py','self_test_capability_ledger_v6_18_7.py','self_test_capability_disposition_v6_18_7.py'}
for row in rows:
...
print('PASS: v6.18.7 95/95 historical COMPLETE capability disposition coverage gate')
