...
validate_manifest(representative); assert check_compatibility(representative,'6.17.14')==[]
print('PASS: v6.17.14 exact PATCH schema, preflight, compatibility and partial-modification detection')
