...
with tempfile.TemporaryDirectory(prefix='ptv613_inspect_') as td:
    ...
    manifest={'schema_version':1,'patch':{'id':'inspect'},'targets':['target.txt'],'compatibility':{'min_tool_version':'6.12.0','max_tested_version':'6.17.14'}}
...
print('PASS: v6.17.14 inspect/dry-run and COLLECT quality summary')
