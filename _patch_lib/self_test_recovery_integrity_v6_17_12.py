...
assert q.VERSION == '6.17.12'
assert r.VERSION == '6.17.12'
...
# 5) Unsafe artifact root is a clean fail-closed CLI result, not an uncaught
# traceback path.
...
print('PASS: v6.17.12 recovery identity, rollback replay dedupe exception, unbounded ignored-file fail-safe and clean artifact safety error')
