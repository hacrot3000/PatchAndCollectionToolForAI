...
with tempfile.TemporaryDirectory(prefix='ptv613_recovery_') as td:
    ...
    # v6.19.4 executes the unrelated later PATCH, but the failed preflight row
...
print('PASS: v6.19.4 diagnosis, FAIL_HANDOFF, source-drift recollection, LAST_RUN/resume/history')
