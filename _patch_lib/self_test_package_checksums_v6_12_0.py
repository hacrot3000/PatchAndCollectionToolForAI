...
required={
 ...
 'tools/_patch_lib/self_test_self_contained_v6_12_0.py','tools/_patch_lib/self_test_docs_v6_12_0.py',
}
...
print('PASS: v6.12.0 self-contained package SHA256SUMS exact coverage and executable launcher')
