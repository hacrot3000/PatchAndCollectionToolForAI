...
assert patch_schema['tool_version']=='6.17.8' and patch_schema['schema_version']==1
...
assert checklist['tool_version']=='6.17.8' and 'READY_TO_APPLY' in checklist['result_classes']
assert collect_schema['tool_version']=='6.17.8'
for phrase in [
...
print('PASS: v6.17.8 diagnostics, Windows parity docs, schemas/checklist and minimal user HTML contract')
