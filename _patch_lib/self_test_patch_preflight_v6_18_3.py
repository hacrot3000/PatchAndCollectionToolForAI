...
validate_manifest(representative); assert check_compatibility(representative,'6.18.3')==[]
print('PASS: v6.18.3 exact PATCH schema, preflight, compatibility and partial-modification detection')
