...
GIT_SAFE=HERE.parent/'python_patch_git_safe.py'
REGEX_WORKER=HERE.parent/'python_patch_collect_regex_worker.py'
DB_SELECT=HERE.parent/'python_patch_database_select.py'
CLEARTEXT=HERE.parent/'python_patch_cleartext_companion.py'
AI_SYNC=HERE.parent/'python_patch_ai_sync.py'
...
def make_project(tmp: Path):
    ...
    (lib/'python_patch_git_safe.py').write_bytes(GIT_SAFE.read_bytes())
    (lib/'python_patch_collect_regex_worker.py').write_bytes(REGEX_WORKER.read_bytes())
    (lib/'python_patch_database_select.py').write_bytes(DB_SELECT.read_bytes())
    (lib/'python_patch_cleartext_companion.py').write_bytes(CLEARTEXT.read_bytes())
    (lib/'python_patch_ai_sync.py').write_bytes(AI_SYNC.read_bytes())
...
print('PASS: v6.20.0 all documented PATCH execution routes force in-place mode')
