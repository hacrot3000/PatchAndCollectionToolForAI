...
assert current['current_version']=='6.18.5'
...
surface_only={'self_test_upgrade_continuity_v6_18_5.py','self_test_capability_ledger_v6_18_5.py','self_test_capability_disposition_v6_18_5.py'}
for row in rows:
...
print('PASS: v6.18.5 95/95 historical COMPLETE capability disposition coverage gate')
