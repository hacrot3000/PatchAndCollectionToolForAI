...
with tempfile.TemporaryDirectory(prefix='ptv612_pack_') as td:
    ...
    with zipfile.ZipFile(results[0]) as z:
        ...
        assert manifest['tool_version']=='6.18.6' and manifest['file_count']==2
...
print('PASS: v6.18.6 self-contained COLLECT current/restored action schema and unknown-action fail-closed')
