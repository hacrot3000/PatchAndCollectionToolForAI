...
with tempfile.TemporaryDirectory(prefix='ptv612_pack_') as td:
    ...
    with zipfile.ZipFile(results[0]) as z:
        ...
        assert manifest['tool_version']=='6.14.0' and manifest['file_count']==2
...
print('PASS: v6.14.0 self-contained COLLECT actions pack/overview/find/search/git and exact schema')
