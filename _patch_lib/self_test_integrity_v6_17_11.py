...
assert queue.VERSION == '6.17.11'
assert batch.VERSION == '6.17.11'
assert runner.VERSION == '6.17.11'
...
print('PASS: v6.17.11 package identity, replay snapshot, mutation lock and FAIL_HANDOFF artifact integrity')
