...
assert patch_schema['tool_version']=='6.17.14' and patch_schema['schema_version']==1
...
assert checklist['tool_version']=='6.17.14' and 'READY_TO_APPLY' in checklist['result_classes']
assert collect_schema['tool_version']=='6.17.14'
for phrase in [
...
print('PASS: v6.17.14 diagnostics, Windows parity docs, schemas/checklist and minimal user HTML contract')
