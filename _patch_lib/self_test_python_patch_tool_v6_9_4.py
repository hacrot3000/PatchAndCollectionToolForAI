...
names=[
    'self_test_version_consistency_v6_9_4.py',
    'self_test_inplace_routing_v6_9_4.py',
    'self_test_queue_discovery_v6_9_4.py',
    'self_test_local_duplicate_v6_9_4.py',
    'self_test_selection_contract_v6_9_4.py',
    'self_test_fail_fast_v6_9_4.py',
    'self_test_collect_progress_v6_9_4.py',
    'self_test_ai_collect_contract_v6_9_4.py',
    'self_test_package_checksums_v6_9_4.py',
]
...
for name in names:
    ...
    if rc:
        raise SystemExit(rc)
print('PASS: Python Patch Tool v6.9.4 regression suite')
