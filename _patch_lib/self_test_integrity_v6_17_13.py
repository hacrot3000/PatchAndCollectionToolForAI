...
assert queue.VERSION == '6.17.13'
assert batch.VERSION == '6.17.13'
assert runner.VERSION == '6.17.13'
...
print('PASS: v6.17.13 package identity, replay snapshot, mutation lock and FAIL_HANDOFF artifact integrity')
