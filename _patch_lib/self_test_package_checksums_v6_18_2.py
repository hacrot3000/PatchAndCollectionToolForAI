...
required={
 ...
 'tools/_patch_lib/docs/AI_USAGE_CONTRACT.md','tools/_patch_lib/docs/CODE_COLLECTION_GUIDE.md','tools/_patch_lib/docs/NO_SILENT_REMOVAL_POLICY.md','tools/_patch_lib/docs/CAPABILITY_LEDGER.md','tools/_patch_lib/docs/HISTORICAL_FEATURE_BASELINE_V5_15.md',
 'tools/_patch_lib/self_test_self_contained_v6_18_2.py','tools/_patch_lib/self_test_docs_v6_18_2.py','tools/_patch_lib/self_test_batch_engine_v6_18_2.py','tools/_patch_lib/self_test_windows_native_lane_v6_18_2.py',
 'tools/_patch_lib/self_test_safe_rollback_v6_18_2.py','tools/_patch_lib/self_test_planning_features_v6_18_2.py','tools/_patch_lib/self_test_tool_health_v6_18_2.py','tools/_patch_lib/self_test_audit_fixes_v6_18_2.py','tools/_patch_lib/self_test_integrity_v6_18_2.py','tools/_patch_lib/self_test_recovery_integrity_v6_18_2.py','tools/_patch_lib/self_test_execution_audit_v6_18_2.py',
 'tools/_patch_lib/self_test_history_live_status_v6_18_2.py',
 'tools/_patch_lib/self_test_upgrade_continuity_v6_18_2.py',
 'tools/_patch_lib/self_test_historical_compatibility_v6_18_2.py','tools/_patch_lib/self_test_capability_ledger_v6_18_2.py',
}
...
print('PASS: v6.18.2 self-contained package SHA256SUMS exact coverage and public launchers')
