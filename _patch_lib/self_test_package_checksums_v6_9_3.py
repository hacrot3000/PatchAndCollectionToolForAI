...
required = {
    ...
    "tools/_patch_lib/self_test_python_patch_tool_v6_9_3.py",
    "tools/_patch_lib/self_test_local_duplicate_v6_9_3.py",
}
...
print("PASS: v6.9.3 package SHA256SUMS validates clean releases and installed overlays")
