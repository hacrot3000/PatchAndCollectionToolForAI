...
version=(root/'VERSION').read_text(encoding='utf-8').strip(); assert version=='6.17.10',version
for rel in ['python_patch_queue_dispatcher.py','python_patch_collect_progress_v6_7.py','python_patch_collect_compat.py','python_patch_collect_regex_worker.py','python_patch_collect_schema.py','python_patch_runner.py','python_patch_utils.py','python_patch_package_schema.py','python_patch_health.py','python_patch_batch.py','python_patch_project_state.py']:
    text=(root/rel).read_text(encoding='utf-8'); assert 'VERSION = "6.17.10"' in text,(rel,version)
launcher=(tools/'run_python_patches.sh').read_text(encoding='utf-8'); assert 'v6.17.10' in launcher
ps=(tools/'run_python_patches.ps1').read_text(encoding='utf-8'); assert 'v6.17.10' in ps
bat=(tools/'run_python_patches.bat').read_text(encoding='utf-8'); assert 'v6.17.10' in bat
master=(root/'self_test_python_patch_tool_v6_17_10.py').read_text(encoding='utf-8')
for name in [
 'self_test_windows_launchers_v6_17_10.py',
 'self_test_windows_native_lane_v6_17_10.py',
 'self_test_collect_progress_v6_17_10.py','self_test_local_duplicate_v6_17_10.py','self_test_result_clarity_v6_17_10.py','self_test_collect_exclusivity_v6_17_10.py',
 ...
 'self_test_collect_pack_v6_17_10.py','self_test_self_contained_v6_17_10.py','self_test_docs_v6_17_10.py',
 'self_test_patch_preflight_v6_17_10.py','self_test_safe_rollback_v6_17_10.py','self_test_patch_recovery_v6_17_10.py','self_test_fail_handoff_sources_v6_17_10.py','self_test_inspect_quality_v6_17_10.py','self_test_tool_health_v6_17_10.py','self_test_robustness_v6_17_10.py','self_test_audit_fixes_v6_17_10.py','self_test_integrity_v6_17_10.py','self_test_planning_features_v6_17_10.py']:
...
print('PASS: v6.17.10 runtime/docs/version/master coverage synchronized')
