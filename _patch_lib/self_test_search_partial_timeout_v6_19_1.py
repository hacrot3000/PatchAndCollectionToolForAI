...
print('PASS: v6.19.1 regex large-tree optimization, partial-timeout checkpoint and INCOMPLETE preservation contract')
...
print('PASS: v6.19.1 discovery/output quota partial-preservation contract')
...
print('PASS: v6.19.1 exact pack quota remains fail-closed')
