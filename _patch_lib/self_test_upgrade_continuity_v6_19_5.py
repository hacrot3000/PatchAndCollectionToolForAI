...
assert (HERE/'self_test_collect_historical_actions_v6_19_5.py').is_file()
...
print('PASS: v6.19.5 upgrade continuity guard preserves current capabilities and requires historical behavioral/ledger gates')

# v6.19.5 UX continuity: normal startup must group previous failures rather than auto-open Smart Resume.
...
assert (HERE/'self_test_failed_queue_grouping_v6_19_5.py').is_file()

# v6.19.5 persistent failure-state continuity.
...
assert (HERE/'self_test_failed_queue_persistence_v6_19_5.py').is_file()
