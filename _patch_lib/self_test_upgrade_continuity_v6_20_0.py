...
print('PASS: v6.20.0 upgrade continuity guard preserves current capabilities and requires historical behavioral/ledger gates')

# v6.20.0 UX continuity: normal startup must group previous failures rather than auto-open Smart Resume.
...
# v6.20.0 persistent failure-state continuity.
