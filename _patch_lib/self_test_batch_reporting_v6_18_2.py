...
# even though v6.18.2 defaults to continue_independent.
mixed={
...
# Renderer supports the v6.18.2 continue_independent default: multiple FAIL rows
...
print('PASS: v6.18.2 persistent batch summary, aggregate/detail logs, continuation/safety-stop status model and report browser')
