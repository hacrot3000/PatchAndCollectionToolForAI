...
# v6.17.3 keeps fail-fast as the default execution contract.
all_failed={
...
print('PASS: v6.17.3 persistent batch summary, aggregate/detail logs, fail-fast status model and report browser')
