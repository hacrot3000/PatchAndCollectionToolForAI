...
assert a.VERSION==q.VERSION=='6.19.4'
...
print('PASS: v6.19.4 copy-friendly short hard-link upload aliases keep ACTION REQUIRED paths on dedicated rows with safe fallback')
