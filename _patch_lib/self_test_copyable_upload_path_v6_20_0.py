...
assert a.VERSION==q.VERSION=='6.20.2'
...
print('PASS: v6.20.2 copy-friendly short hard-link upload aliases keep ACTION REQUIRED paths on dedicated rows with safe fallback')
