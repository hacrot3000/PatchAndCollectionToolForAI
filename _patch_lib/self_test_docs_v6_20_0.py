...
assert patch_schema['tool_version']=='6.20.2' and patch_schema['schema_version']==1
...
assert checklist['tool_version']=='6.20.2' and 'READY_TO_APPLY' in checklist['result_classes']
assert collect_schema['tool_version']=='6.20.2'
for phrase in [
