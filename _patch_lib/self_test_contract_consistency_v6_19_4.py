...
print('PASS: v6.19.4 contract consistency for unresolved failures, dependency blocking, plan policy/recipe and project config parsing')
...
print('PASS: v6.19.4 exact-SHA previous_failure delete resolution under patch.id reuse')
...
with tempfile.TemporaryDirectory(prefix='ptv61710_recipe_no_mutation_') as td:
    ...
    recipe={
        'format':'python-patch-tool-batch-recipe','format_version':1,'tool_version':'6.19.4',
...
print('PASS: v6.19.4 recipe validation precedes duplicate-history queue mutation')
...
print('PASS: v6.19.4 recipe execution leaves unrelated queue entries untouched')
...
print('PASS: v6.19.4 recipe patch_id is SHA-bound execution identity')
...
print('PASS: v6.19.4 recipe policies cannot be overridden during replay')
