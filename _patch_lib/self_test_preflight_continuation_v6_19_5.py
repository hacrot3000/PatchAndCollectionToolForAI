...
assert (HERE/'VERSION').read_text(encoding='utf-8').strip() == '6.19.5'
...
print('PASS: v6.19.5 item-local batch preflight failures continue independent PATCHes and block only related successors')
