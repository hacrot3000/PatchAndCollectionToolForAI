...
validate_manifest(representative); assert check_compatibility(representative,'6.17.9')==[]
print('PASS: v6.17.9 exact PATCH schema, preflight, compatibility and partial-modification detection')
