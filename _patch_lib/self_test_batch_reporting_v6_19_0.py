...
# even though v6.19.0 defaults to continue_independent.
mixed={
...
# Renderer supports the v6.19.0 continue_independent default: multiple FAIL rows
...
print('PASS: v6.19.0 persistent batch summary, aggregate/detail logs, continuation/safety-stop status model and report browser')
