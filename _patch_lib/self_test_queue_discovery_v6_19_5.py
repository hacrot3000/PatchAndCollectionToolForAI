...
with tempfile.TemporaryDirectory() as td:
    ...
    with zipfile.ZipFile(p/'python_patch_tool_v6.19.5.zip','w') as z:
    ...
    assert 'python_patch_tool_v6.19.5.zip' in joined
...
print('PASS: v6.19.5 queue recognizes PATCH/COLLECT structurally and skips non-patch artifacts')
