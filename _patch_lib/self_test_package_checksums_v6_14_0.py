...
required={
 ...
 'tools/_patch_lib/self_test_self_contained_v6_14_0.py','tools/_patch_lib/self_test_docs_v6_14_0.py',
 'tools/_patch_lib/self_test_safe_rollback_v6_14_0.py','tools/_patch_lib/self_test_tool_health_v6_14_0.py',
}
...
print('PASS: v6.14.0 self-contained package SHA256SUMS exact coverage and executable launcher')
