...
assert queue.VERSION == '6.17.14'
assert batch.VERSION == '6.17.14'
assert runner.VERSION == '6.17.14'
...
print('PASS: v6.17.14 package identity, replay snapshot, mutation lock and FAIL_HANDOFF artifact integrity')
