...
assert sync.VERSION==q.VERSION=='6.19.5'
...
with tempfile.TemporaryDirectory(prefix='ptv_ai_sync_collect_') as td:
    ...
    fourth=collect(root,'sync4',{'known_tool_version':'6.19.5','sync_token':token,'agent_id':'agent-c'})
...
print('PASS: v6.19.5 AI tool-version/capability sync is stateful, one-shot, artifact-contained and legacy-compatible')
