...
assert current['current_version']=='6.19.2'
...
surface_only={'self_test_upgrade_continuity_v6_19_2.py','self_test_capability_ledger_v6_19_2.py','self_test_capability_disposition_v6_19_2.py'}
for row in rows:
...
print('PASS: v6.19.2 95/95 historical COMPLETE capability disposition coverage gate')
