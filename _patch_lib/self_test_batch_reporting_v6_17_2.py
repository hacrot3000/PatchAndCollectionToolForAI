...
# v6.17.2 keeps fail-fast as the default execution contract.
all_failed={
...
print('PASS: v6.17.2 persistent batch summary, aggregate/detail logs, fail-fast status model and report browser')
